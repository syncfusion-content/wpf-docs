...
4. Add an [SfTreeNavigator](https://help.syncfusion.com/cr/wpf/Syncfusion.Windows.Controls.Navigation.SfTreeNavigator.html) control instance to your view (for example, inside `MainWindow.xaml`).
...
2. Add a reference to the [Syncfusion.SfTreeNavigator.Wpf](https://www.nuget.org/packages/Syncfusion.SfTreeNavigator.Wpf) NuGet package.
3. Import the namespace `Syncfusion.Windows.Controls.Navigation` in XAML or C# code.
4. Add an [SfTreeNavigator](https://help.syncfusion.com/cr/wpf/Syncfusion.Windows.Controls.Navigation.SfTreeNavigator.html) control instance to your window's content.
