---
layout: post
title: Collapsing TaskBar in WPF TaskBar | Syncfusion®
description: Collapsing the WPF TaskBar helps optimize screen space by minimizing groups while keeping content accessible when needed.
platform: wpf
control: TaskBar
documentation: ug
---

# Collapsing TaskBar in WPF TaskBar
