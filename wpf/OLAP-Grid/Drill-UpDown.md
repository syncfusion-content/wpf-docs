---
layout: post
title: Drill Down/Up in WPF OlapGrid | Syncfusion®
description: The drill down/up support in OlapGrid lets you expand or collapse members to access detailed or summarized data using the built-in expanders.
platform: wpf
control: OlapGrid
documentation: ug
---

#  Drill Down/Up in WPF OlapGrid
