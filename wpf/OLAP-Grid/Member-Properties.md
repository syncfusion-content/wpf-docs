...
description: The member properties support in OLAP Grid binds members along with their properties such as name, parent level, and number of children for detailed information.
platform: wpf
control: OLAP Grid
documentation: ug
---
