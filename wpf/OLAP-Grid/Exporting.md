---
layout: post
title: Exporting in WPF OlapGrid | Syncfusion®
description: The exporting support in OlapGrid enables exporting grid data to Microsoft Excel, Microsoft Word, PDF, and CSV file formats.
platform: wpf
control: OlapGrid
documentation: ug
---

# Exporting in WPF OlapGrid
