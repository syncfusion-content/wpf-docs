---
layout: post
title: Exporting in WPF OLAP Grid | Syncfusion®
description: The exporting support in OLAP Grid enables exporting grid data to Microsoft Excel, Microsoft Word, PDF, and CSV file formats.
platform: wpf
control: OLAP Grid
documentation: ug
---
