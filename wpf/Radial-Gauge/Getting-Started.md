...
You can drag the circular gauge control from the  toolbox and drop it to the designer. It will automatically install the required NuGet packages and add the namespace to the page. 
