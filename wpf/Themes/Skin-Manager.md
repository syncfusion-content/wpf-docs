---
layout: post
title: WPF Skin Manager | Apply Themes for Syncfusion<sup>&reg;</sup> WPF controls
description: Learn about how to apply the themes for Syncfusion<sup>&reg;</sup> WPF controls and Framework controls using the skin manager.
platform: wpf
control: Themes
documentation: ug
---
