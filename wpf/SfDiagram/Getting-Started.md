...
We have provided the Default binding Style support to bind the ViewModel proerties  to View by using “BindingStyle.xaml”. For more information, refer to [Data Binding](/wpf/sfdiagram/Data-Binding).
