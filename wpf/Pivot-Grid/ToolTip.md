...
description: Tooltip in the Syncfusion® WPF Pivot Grid control displays cell values with row and column details, and supports customization for enhanced analysis.
platform: wpf
control: Pivot Grid
documentation: ug
---
