---
layout: post
title: Setting Caption in PivotTableFieldList in WPF PivotGrid | Syncfusion®
description: Setting Caption in PivotTableFieldList of the Syncfusion® WPF PivotGrid control customizes field captions in the field list for clarity and better usability.
platform: wpf
control: Pivot grid
documentation: ug
---

# Setting Caption in PivotTableFieldList in WPF PivotGrid
