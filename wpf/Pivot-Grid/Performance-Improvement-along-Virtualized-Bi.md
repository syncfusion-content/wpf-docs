---
layout: post
title: Virtualized Binding in WPF PivotGrid | Syncfusion®
description: Improve performance in the Syncfusion® WPF PivotGrid control with virtualized binding to efficiently handle large datasets and optimize memory usage.
platform: wpf
control: Pivot grid
documentation: ug
---

# Virtualized Binding in WPF PivotGrid
