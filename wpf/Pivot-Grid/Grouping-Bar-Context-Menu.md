...
description: Use the grouping bar context menu in the Syncfusion® WPF Pivot Grid control to manage fields with options for flexible pivot table customization.
platform: wpf
control: Pivot grid
documentation: ug
---
