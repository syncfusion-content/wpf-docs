---
layout: post
title: Exporting in WPF PivotGrid | Syncfusion®
description: Export data from the Syncfusion® WPF PivotGrid control to Excel, PDF, and other formats for easy sharing and reporting.
platform: wpf
control: Pivot grid
documentation: ug
---

# Exporting in WPF PivotGrid
