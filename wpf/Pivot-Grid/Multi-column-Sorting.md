---
layout: post
title: Multi-Column Sorting in WPF PivotGrid | Syncfusion®
description: Apply multi-column sorting in the Syncfusion® WPF PivotGrid control to organize data by multiple fields, enabling flexible and detailed pivot analysis.
platform: wpf
control: Pivot grid
documentation: ug
---

# Multi-Column Sorting in WPF PivotGrid
