...
MaskFormat</td><td>
MaskFormat</td><td>
Specifies the display format when mask value is used. It determines whether the literals and prompt characters are included in the formatted string. To know more about MaskFormat {{ '[Click Here](http://help.syncfusion.com/wpf/sfdatagrid/columns#gridmaskcolumn)' | markdownify }}</td><td>
...
N> Due to its behavior (Directly loading CheckBox), it does not fire events of CurrentCellValidating and CurrentCellValidated. You can use CurrentCellValueChanged Event._
...
Columns</td><td>
Columns</td><td>
This is a collection of GridColumns that helps to generate columns based on the given GridColumns (For information about GridColumns, see {{ '[Columns](http://help.syncfusion.com/wpf/sfdatagrid/columns)' | markdownify }}).</td><td>
new Columns()</td></tr>
<tr>
<td>
...
<tr>
<th>
> {{ 'N> The above methods are useful when you create custom GridColumnSizer for SfDataGrid._' | markdownify }}</th></tr>
<tr>
<td>
</td></tr>
</table>
...
SfDataGrid allows you to create your own column other than SfDataGrid predefined [column collection](http://help.syncfusion.com/wpf/sfdatagrid/columns#column-creation). 
...
renderers with [renderer replacement](http://help.syncfusion.com/wpf/sfdatagrid/columns#creating-custom-renderer-for-column) or can be adding new custom renderer to 
...
You can create custom renderer by deriving from GridVirtualizingCellRenderer<D, E>. It contains generic parameters Where ‘D’ denotes the type display control and ‘E’ denotes the type of edit control. You can load your custom control as display or edit control or you can also load standard controls (TextBlock, Text Box, Combo Box…) and you can customize it in your way. You can also override the existing renderers and you can create customized one. There are some list of existing [renderers](http://help.syncfusion.com/wpf/sfdatagrid/columns#creating-custom-renderer-for-column) available in SfDataGrid.
...
N> Default value of GridSummaryRow.ShowSummaryInRow is true._
...
N> To use GetRecordAtRowIndex method, you can refer Syncfusion.UI.Xaml.Grid.Helper._
...
N> The listed key navigation behaves same as multiple selection. But current cell moves selection, does not move in single selection. In extended mode, all selection modes are like single mode other than Shift+UP/Down selects multiple records and move towards its direction.
...
control, you can [click here](http://help.syncfusion.com/wpf/sfdatapager).
...
N> By default, Silverlight does not support StyleSelectors hence DataGrid too.
...
(int RowIndex) method in the [CurrentCellEndEdit](http://help.syncfusion.com/wpf/sfdatagrid/editing#currentcellendedit) event of the SfDataGrid and it resets the row height internally. 
...
N> Using IDataErrorInfo, you can retrieve the error string from Error Field, whereas using INotifyDataErrorInfo the error is retrieved when the HasError Field value is ‘true’._
...
N> By Default QTP supports higher Framework version installed in your machine. When you want to make use of SfDataGrid in a lower framework version, you need to copy and paste the SfGridQTP.WPF DLL in preferred locations._ DLL Copy Location: C:\Program Files\Syncfusion\Essential QTP\12.4.0.24\WPF\bin\ DLL Paste Location: C:\Program Files\HP\QuickTestProfessional\data\Extensibility\WPF\Syncfusion
