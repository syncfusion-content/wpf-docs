---
layout: post
title: Syncfusion Essential WPF SfDataGrid Interactive feature
...
![Context menu added for data rows in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img1.png)
...
![Context menu added for header row in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img2.png)
...
![Context menu added for GroupDropArea in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img3.png)
...
![Context menu added for GroupDropItem in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img4.png)
...
![Context menu added for group caption rows in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img5.png)
...
![Context menu added for group summary rows in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img6.png)
...
![Context menu added for table summary rows in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img7.png)
...
![Context menu changed for record cell while opening in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img8.png)
...
![Context menu background changed in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img9.png)
...
![Opening column chooser in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img10.png)
...
![Customized column chooser in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img12.png)
...
![Customized column chooser appearance in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img12.png)
...
![Row header enabled in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img13.png)
...
![Row index displayed in row header cell of WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img14.png)
...
![Current row indicator changed in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img15.png)
...
![Background of row header changed in WPF SfDataGrid](Interactive-Features_images/InteractiveFeatures_img16.png)
