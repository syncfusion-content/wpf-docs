---
layout: post
title: Close TileViewItem in WPF TileView | Syncfusion®
description: Close TileViewItem elements in the Syncfusion WPF TileView (TileViewControl) using the built-in close button visibility option.
platform: wpf
