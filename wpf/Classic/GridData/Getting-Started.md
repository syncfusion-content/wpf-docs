...
The GridDataControl is designed to be bound with a data source. In the GridDataControl, each column behaves as a single entity. This grid is more column-centric and can be used to display interrelated tabular data. Unlike the base grid, this grid does not store data values in its data structures; instead, it is connected to an external data source.
...
![Control hierarchy](Getting-Started_images/Getting-Started_img4.png)

### Model Hierarchy

![Model hierarchy](Getting-Started_images/Getting-Started_img5.png)
...
2. Add the following Syncfusion assemblies to the project.
   ...
   ![Added assemblies to the project](Getting-Started_images/Getting-Started_img9.png)
...
### Add the GridDataControl to a WPF Application

This section shows you how to add a GridDataControl to a WPF application and how to bind data from a database and an IEnumerable Collection to the control. The GridDataControl can be added to an application through programmatically.

### Programmatically Adding the GridDataControl:
...
### Binding a Data Source to the GridDataControl

The previous section explained how to add a GridDataControl to an application. This section explains how to bind a data source with the control after it is added.
...
This section explains how to bind data tables and IEnumerable collections to the control.

### Binding Data Tables to the GridDataControl

This section explains how to bind a data table from a database to the GridDataControl.
...
![Binding data tables to the control](Getting-Started_images/Getting-Started_img14.png)
...
1. Create a collection of objects to bind with the GridDataControl. In this sample, we have created a collection of objects containing personnel information.
...
![Binding with IEnumerable collection](Getting-Started_images/Getting-Started_img15.png)
