...
<tr>
<td>
{% highlight C# %}myGroupBar.AllowCollapse = true;{% endhighlight %}</td></tr>
</table>
...
<tr>
<td>
{% highlight C# %}//Set the visual mode as stack modegroupBar.VisualMode = VisualMode.StackMode;//Collapsing the GroupBar in stack modegroupBar.IsCollapsed = true;{% endhighlight %}</td></tr>
</table>
