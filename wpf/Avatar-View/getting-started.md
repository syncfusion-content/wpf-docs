...
This section explains the steps required to add the WPF [AvatarView ](https://help.syncfusion.com/cr/wpf/Syncfusion.Windows.Shared.SfAvatarView.html) control with its basic features.
...
4. Initialize the AvatarView  control in your XAML file.
