---
layout: post
title: Step Interval in WPF PercentTextBox | Syncfusion®
description: Define the increment or decrement step used by the Syncfusion WPF PercentTextBox control when changing the value with spinner or keys.
platform: wpf
