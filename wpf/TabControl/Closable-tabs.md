...
* Hide – All close buttons are hidden in the tab panel.
...
![Common close button and individual close buttons shown in tab panel](Closable-tabs-images/CloseButtonType_Both.png)
