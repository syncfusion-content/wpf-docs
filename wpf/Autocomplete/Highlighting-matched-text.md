...
You can highlight matching characters in a suggestion list to pick an item with more clarity using [TextHighlightMode](https://help.syncfusion.com/cr/wpf/Syncfusion.SfInput.Wpf~Syncfusion.Windows.Controls.Input.SfTextBoxExt~TextHighlightModeProperty.html) property. The matching text can be highlighted in the following two ways:
