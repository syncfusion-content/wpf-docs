---
layout: post
title: Surface Types in WPF Surface Chart | Syncfusion®
description: Surface types in the WPF Surface Chart provide different rendering modes for visualizing three-dimensional data and surface variations.
platform: wpf
