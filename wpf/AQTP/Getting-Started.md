...
11. For Application field, browse and select the path of the application that has to be tested by clicking ![](Getting-Started_images/Getting-Started_img8.png) button.
12. For Working folder field, browse and select the path of the working folder by clicking ![](Getting-Started_images/Getting-Started_img9.png) button.
