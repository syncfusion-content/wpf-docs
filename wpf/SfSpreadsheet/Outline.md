---
layout: post
title: Outlines support in SfSpreadsheet | wpf/Syncfusion
description: This section explains that how to group/ungroup the rows and columns in SfSpreadsheet for wpf/Syncfusion
platform: wpf
