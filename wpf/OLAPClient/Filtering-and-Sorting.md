...
The Filter tab in the Filter and Sorting dialog box of OLAP Client provides options to specify custom filters on the multidimensional 
data to be retrieved. It enables filtering rows and columns of the current (active) Measure. This dialog is invoked through the Filter toolbar item.
...
![](Filtering-and-Sorting_images/Filtering-and-Sorting_img6.png)
...
![](Filtering-and-Sorting_images/Filtering-and-Sorting_img7.png)



![](Filtering-and-Sorting_images/Filtering-and-Sorting_img8.png)



By Checking the Sort check box we can set the sorting for the current report.

![](Filtering-and-Sorting_images/Filtering-and-Sorting_img9.png)
