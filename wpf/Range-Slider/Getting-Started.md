---
layout: post
title: Getting Started with WPF SfRangeSlider | Syncfusion®
description: Learn how to get started with the Syncfusion® WPF SfRangeSlider control. Explore setup, features, examples, and customization options.
platform: wpf
