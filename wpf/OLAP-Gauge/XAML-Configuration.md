...
XAML configuration is one of the important features of the OLAP gauge, as it helps users configure the control entirely through XAML by eliminating the code required in the code-behind.
...
The following code snippet illustrates adding an OLAP report to the OLAP gauge at design time.
