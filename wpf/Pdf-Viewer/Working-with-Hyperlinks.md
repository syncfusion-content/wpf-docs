...
N> In version 19.3.0.43, The API names HyperLinkClicked and HyperLinkMouseOver is changed to HyperlinkClicked and HyperlinkMouseOver and the HyperLinkClickedEventArgs is changed to HyperlinkClickedEventArgs.
