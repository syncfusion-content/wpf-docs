...
description: Learn here all about getting started with Syncfusion Essential Studio WPF PDF Viewer control, its elements and more.
platform: wpf
control: PDF Viewer
documentation: ug
---

# Getting Started with WPF PDF Viewer Control
