...
Once the underline inclusion mode is activated, you can underline the required text by selecting it. You can select the text by holding down the left mouse button and dragging the mouse pointer over the text. The following image shows the underlined text in the PDF file.
