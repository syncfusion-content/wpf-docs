...
![WPF PDFViewer Before applying rectangle annotation border style](Annotation-images\Rectangle-Annotation-11.png)

The following image illustrates the change of thickness in the selected rectangle annotation.

![WPF PDFViewer After applying rectangle annotation border style](Annotation-images\Rectangle-Annotation-12.png)
...
![After applying polygon border style](Annotation-images\Polygon-Annotation-14.png)
...
![Cloud shape option in toolbar](Annotation-images\Polygon-Annotation-15.png)
