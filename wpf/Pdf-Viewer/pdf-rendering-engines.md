...
N> From v20.1.0.x onwards, the Pdfium is upgraded to the new version which was built with the branch [chromium/4880](https://pdfium.googlesource.com/pdfium/+/refs/heads/chromium/4880).
