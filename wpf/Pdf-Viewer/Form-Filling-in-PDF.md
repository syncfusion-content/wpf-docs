...
To clicking the signature box it will open the signature pad, requesting the user to draw the signature. Clicking on apply button it will add the signature in the signature form field.
