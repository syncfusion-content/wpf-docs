...
When the window state is in MDI, child of docking manager will be hosted inside the DocumentContainer. So, user can customize child using DocumentContainer. Refer to this [DocumentContainer documentation](https://help.syncfusion.com/wpf/documentcontainer/getting-started) for customizing DocumentContainer.
