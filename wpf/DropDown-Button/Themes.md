...
{% highlight xaml %}
    ...
    <Window x:Class="DropDownButton_Sample.MainWindow"
        ...
        <Grid>
            <syncfusion:DropDownButtonAdv x:Name="dropdownbutton" syncfusionskin:SfSkinManager.VisualStyle="Blend" Label="Sign in with your Syncfusion Account" Sizemode="Large" LargeIcon="image\employee.png"/>
        </Grid> 
    </Window>
...
{% highlight C# %}
    ...
    SfSkinManager.SetVisualStyle(dropdownbutton, VisualStyles.Blend); 

{% endhighlight %}
{% endtabs %}

Now run the application and can see the blend theme applied for Dropdown Button control respectively.
