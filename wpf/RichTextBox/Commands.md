...
keywords: commands
---
# This section illustrates the list of built-in commands supported in WPF RichTextBox control
...
<td>
The {{'[TextAlignment](https://help.syncfusion.com/cr/wpf/Syncfusion.SfRichTextBoxAdv.WPF~Syncfusion.Windows.Controls.RichTextBoxAdv.ParagraphFormat~TextAlignment.html)'| markdownify}} value to be applied.
</td>
</tr>
<tr>
<td>
