...
1. Add the below required assembly references to the project,
	...
	* Syncfusion.SfTreeView.WPF
	* Syncfusion.SfGridCommon.WPF
2. Import SfTreeView namespace **using Syncfusion.UI.Xaml.WPF TreeView** .
