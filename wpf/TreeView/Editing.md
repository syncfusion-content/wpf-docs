...
By default, you can move to editmode by pressing `F2` key. TreeView allows you to edit the node in single click(Tap) or double click(DoubleTap) by setting `EditTrigger` property.
