...
- The [Syncfusion.WPF.MCP](https://www.nuget.org/packages/Syncfusion.WPF.MCP) .NET packages is now available on NuGet, enabling seamless integration of Syncfusion WPF controls with MCP-based workflows.
