---
layout: post
title: Paging| OLAP Grid | Wpf | Syncfusion
description: paging
platform: wpf
control: OLAP Grid
documentation: ug
...
Paging in OlapGrid provides you support to load and render large amount of data without any performance constraint.  

OlapPager user control is included and bounded with the same OlapDataManager object of OlapGrid. To enable paging, set EnablePaging property of OlapReport to True.
