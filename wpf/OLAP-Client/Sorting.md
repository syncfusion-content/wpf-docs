---
layout: post
title: Sorting in WPF OLAP Client | Syncfusion®
description: The sorting support in OLAP Client sorts results by rows or columns in ascending or descending order based on row and column totals.
platform: wpf
control: OLAP Client
documentation: ug
---
