...
2. On the **File** menu, select **New Project**. The **New Project** dialog box opens.
   ...
   ![ComboBox_images5](ComboBoxAdv_images/ComboBoxAdv_img5.png)

3. In the **Project type** pane, select **WPF**, and then select **WPF Application**.
