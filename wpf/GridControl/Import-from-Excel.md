---
layout: post
title: Import from Excel in WPF GridControl control | Syncfusion
description: Learn about Import from Excel support in Syncfusion WPF GridControl control and more.
platform: wpf
control: GridControl
documentation: ug
---
