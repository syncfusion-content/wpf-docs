...
description: Test GridControl applications using UI Automation and Visual Studio Coded UI testing with support for automation patterns, cell access, and validation.
platform: wpf
control: GridControl
documentation: ug
---
