---
layout: post
title: Managing Rows and Columns in WPF GridControl control | Syncfusion
description: Learn about Managing Rows and Columns support in Syncfusion WPF GridControl control and more.
platform: wpf
control: GridControl
documentation: ug
---
