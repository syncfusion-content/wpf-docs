...
## Determinate
Determinate is the default state. You can use it when the progress estimation is known. [ShowProgressValue](https://help.syncfusion.com/cr/wpf/Syncfusion.SfProgressBar.WPF~Syncfusion.UI.Xaml.ProgressBar.SfCircularProgressBar~ShowProgressValueProperty.html) property allows to indicate the progress of the operation taken place  in numerical value.
![Determinate image](States_images/Determinate.png)

## Indeterminate
By enabling the [IsIndeterminate](https://help.syncfusion.com/cr/wpf/Syncfusion.SfProgressBar.WPF~Syncfusion.UI.Xaml.ProgressBar.ProgressBarBase~IsIndeterminateProperty.html) property, the state of the progressbar can be changed to indeterminate when the progress cannot be estimated or when not being calculated.
