...
Modifying the value in the [UpDown](https://help.syncfusion.com/cr/wpf/Syncfusion.Shared.Wpf~Syncfusion.Windows.Shared.UpDown.html) control in the Appearance tab of arrow shape properties window will allow us to modify the thickness of the selected arrow shape.
