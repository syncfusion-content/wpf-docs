...
The following code shows how to bind the IncreaseZoomCommand to a button.
...
{    
      pdfViewerControl.IncreaseZoomCommand.Execute(true);
...
The following code shows how to bind the DecreaseZoomCommand to a button.
...
{ 
   ...
   pdfViewerControl.DecreaseZoomCommand.Execute(true);
...
The following code shows how to bind the FirstPageCommand to a button.
...
{
     pdfViewerControl.FirstPageCommand.Execute(true);
}
...
The following code shows how to bind the LastPageCommand to a button.
...
{
      pdfViewerControl.LastPageCommand.Execute(true);
}
...
The following code shows how to bind the NextPageCommand to a button.
...
{ 
      pdfViewerControl.NextPageCommand.Execute(true);
}
...
The following code shows how to bind the PreviousPageCommand to a button.
...
{ 
      pdfViewerControl.PreviousPageCommand.Execute(true);
}
...
{ 
      pdfViewerControl.GoToPageCommandParameter = "2";
      pdfViewerControl.GoToPageCommand.Execute(true);
}
...
{ 
      pdfViewerControl.PrintCommand.Execute(true);
}
...
The following code shows how to bind the annotation command for line annotation to a Button.
...
{
      pdfViewerControl.AnnotationCommandParameter = "Line";
      pdfViewerControl.AnnotationCommand.Execute(true);
}
...
The following code shows how to bind the annotation command for circle annotation to a Button.
...
{
      pdfViewerControl.AnnotationCommandParameter = "Circle";
      pdfViewerControl.AnnotationCommand.Execute(true);
}
...
The following code shows how to bind the annotation command for rectangle annotation to a Button.
...
{
      pdfViewerControl.AnnotationCommandParameter = "Rectangle";
      pdfViewerControl.AnnotationCommand.Execute(true);
}
...
The following code shows how to bind the annotation command for ink annotation to a Button.
...
{
      pdfViewerControl.AnnotationCommandParameter = "Ink";
      pdfViewerControl.AnnotationCommand.Execute(true);
}
...
The following code shows how to bind the annotation command for strikethrough annotation to a Button.
...
{
      pdfViewerControl.AnnotationCommandParameter = "Strikethrough";
      pdfViewerControl.AnnotationCommand.Execute(true);
}
...
The following code shows how to bind the annotation command for highlight annotation to a Button.
...
{
      pdfViewerControl.AnnotationCommandParameter = "Highlight";
      pdfViewerControl.AnnotationCommand.Execute(true);
}
...
The following code shows how to bind the annotation command for underline annotation to a Button.
...
{
      pdfViewerControl.AnnotationCommandParameter = "Underline";
      pdfViewerControl.AnnotationCommand.Execute(true);
}
