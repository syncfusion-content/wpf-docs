...
N> View [Sample](https://github.com/SyncfusionExamples/wpf-split-button-examples/blob/master/Samples/Data-Binding) in GitHub. This sample that showcases how to bind data and commands to the `SplitButtonAdv` control.
