---
layout: post
title: WPF DataGrid Context Menu | Syncfusion
description: Describes how to create and assign context menu for wpf datagrid rows. Different context menu can be assigned to different types of rows.  
platform: wpf
control: SfDataGrid
documentation: ug
---
