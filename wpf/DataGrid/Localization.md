...
![Displaying Default Resource File into Resources Folder](Localization_images/wpf-datagrid-default-resource-file.png)
...
![Changing name of New Resource File](Localization_images/wpf-datagrid-change-resource-file-name.png)

6.Now, select `Add` option to add the resource file in **Resources** folder.

![Displaying Resource File with German Language](Localization_images/wpf-datagrid-with-german-resource-file.png)
...
![Displaying Added Resource File Name and Value pair](Localization_images/wpf-datagrid-resource-file-name-and-value.png)

![Displaying Localized File in German](Localization_images/wpf-datagrid-localized-file.png)
...
![Displaying Default Culture Resource File Editing](Localization_images/wpf-datagrid-edit-localized-file.png)

Now, change the Name/Value pair in Resource Designer of **Syncfusion.SfGrid.WPF.resx** file.

![Displaying Name and Value pair in Resource Designer for Default Culture](Localization_images/wpf-datagrid-resource-file-name-and-value.png)


![Editing Default Culture Resource](Localization_images/wpf-datagrid-edit-default-resource.png)
