...
![WPF DataGrid displaying the datagrid structure](Styles-and-Templates_images/Styles-and-Templates_img1.png)
...
![WPF DataGrid displaying the VisualTree structure](Styles-and-Templates_images/Styles-and-Templates_img31.png)
...
![WPF DataGrid displaying the Visual Studio Designer style editing for elements](Styles-and-Templates_images/Styles-and-Templates_img3.png)
...
![WPF DataGrid displaying the dotted line border for each record cell](Styles-and-Templates_images/Styles-and-Templates_img5.png)
...
![WPF DataGrid displaying the different style for each StackedHeaderCell](Styles-and-Templates_images/Styles-and-Templates_img11.png)
...
![WPF DataGrid displaying the default style for a column](Styles-and-Templates_images/Styles-and-Templates_img12.png)
...
![WPF DataGrid displaying the row index in row header cell](Styles-and-Templates_images/Styles-and-Templates_img23.png)
...
![WPF DataGrid displaying the different custom templates for cells based on data](Styles-and-Templates_images/Styles-and-Templates_img24.png)
...
![WPF DataGrid displaying the custom header template for column header](Styles-and-Templates_images/Styles-and-Templates_img25.png)
...
![WPF DataGrid displaying appearance customization of DetailsViewDataGrid using DetailsViewDataGridStyle](Styles-and-Templates_images/Styles-and-Templates_img26.png)
...
![WPF DataGrid displaying the custom ascending sort icon](Styles-and-Templates_images/Styles-and-Templates_img27.png)
...
![WPF DataGrid displaying the custom descending sort icon](Styles-and-Templates_images/Styles-and-Templates_img28.png)
...
![WPF DataGrid displaying the busy indicator before loading records](Styles-and-Templates_images/Styles-and-Templates_img30.png)
