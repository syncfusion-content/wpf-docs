...
![WPF DataGrid displaying the single mode row selection](Selection_images/Selection_img1.png)
...
![WPF DataGrid displaying an Extended mode cell selection](Selection_images/Selection_img2.png)
...
![WPF DataGrid displaying the multiple mode cell selection](Selection_images/Selection_img3.png)
...
![WPF DataGrid displaying the programmatic selection of records using SelectedItems property](Selection_images/Selection_img4.png)
...
![WPF DataGrid displaying the programmatic selection of records using SelectRows method](Selection_images/Selection_img5.png)
...
![WPF DataGrid displaying the programmatic selection of cell using SelectCell method](Selection_images/Selection_img6.png)
...
![WPF DataGrid displaying the programmatic selection of cells using SelectCells method](Selection_images/Selection_img7.png)
...
![WPF DataGrid displaying the programmatic removal of selection for a cell using UnSelectCell method](Selection_images/Selection_img8.png)
...
![WPF DataGrid displaying the selection in Master-Details View](Selection_images/Selection_img9.png)
...
![WPF DataGrid displaying the programmatic expansion and scrolling of Master-Details View](Selection_images/Selection_img10.png)
...
![WPF DataGrid displaying the appearance customization of rows](Selection_images/Selection_img11.png)
...
![WPF DataGrid displaying the appearance customization of current cell](Selection_images/Selection_img12.png)
...
![WPF DataGrid displaying customization of row selection border](Selection_images/Selection_img13.png)
...
![WPF SfDataGrid displaying the custom cell selection](Selection_images/Selection_img14.png)
...
![WPF DataGrid displaying the column selection when clicking column header](Selection_images/Selection_img15.png)
