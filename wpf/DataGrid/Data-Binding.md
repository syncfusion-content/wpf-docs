...
This event receives two arguments namely `sender` that handles `SfDataGrid` and [GridItemsSourceChangedEventArgs ](https://help.syncfusion.com/cr/wpf/Syncfusion.html)as objects.

The [GridItemsSourceChangedEventArgs ](https://help.syncfusion.com/cr/wpf/Syncfusion.html)object contains the following properties:
