...
description: WPF DataGrid allows to autosize column widths based on its content. This article explains various auto size options availabel in DataGrid and its customization.
platform: wpf
control: SfDataGrid
documentation: ug
---
