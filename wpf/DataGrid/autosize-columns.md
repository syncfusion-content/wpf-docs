...
description: AutoSize Columns in SfDataGrid automatically adjusts column widths based on content, headers, and available space, with customizable sizing options.
platform: wpf
control: SfDataGrid
documentation: ug
---
