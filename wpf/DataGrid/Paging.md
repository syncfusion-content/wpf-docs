...
![WPF DataGrid Displaying the multiple pages using SfDataPager](Paging_images/Paging_img1.png)
...
![WPF DataGrid displaying page count altering for WPF SfDataPager when applying filter](Paging_images/Paging_img2.png)
