...
![WPF DataGrid displaying the print preview window before printing](Printing_images/Printing_img1.png)
...
![WPF DataGrid displaying Print and Quick Print buttons in print preview window](Printing_images/Printing_img2.png)
...
1. Clicking the Print button opens the System print dialog where user can select the printer and set the number of copies to be printed.
    ...
    ![WPF SfDataGrid displaying the system print dialog for printing](Printing_images/Printing_img3.png)
...
![WPF DataGrid displaying the print scaling options in print preview window](Printing_images/Printing_img4.png)
...
![WPF DataGrid displaying the stacked headers printing](Printing_images/Printing_img23.png)
...
![WPF DataGrid displaying page orientation options in print preview window](Printing_images/Printing_img5.png)
...
![WPF DataGrid displaying the page size options in print preview window](Printing_images/Printing_img6.png)
...
![WPF DataGrid displaying page margin options in print preview window](Printing_images/Printing_img7.png)
...
![WPF DataGrid displaying customized HeaderTemplate and HeaderHeight in print preview window](Printing_images/Printing_img8.png)
...
![WPF DataGrid displaying the customized FooterTemplate and FooterHeight in print preview window](Printing_images/Printing_img9.png)
...
![WPF DataGrid displaying same style as in view using AllowPrintStyles API while printing](Printing_images/Printing_img10.png)
...
![WPF DataGrid displaying the customization of row height while printing](Printing_images/Printing_img12.png)
...
![WPF DataGrid displaying the column removal while printing](Printing_images/Printing_img13.png)
...
![WPF DataGrid displaying the column header text customization while printing](Printing_images/Printing_img14.png)
...
![WPF DataGrid displaying row styling with AllowPrintByDrawing enabled while printing](Printing_images/Printing_img15.png)
...
![WPF DataGrid displaying the row styling with AllowPrintByDrawing disabled while printing](Printing_images/Printing_img16.png)
...
![WPF DataGrid displaying alternate row styling with AllowPrintByDrawing enabled while printing](Printing_images/Printing_img17.png)
...
![WPF DataGrid displaying alternate row styling with AllowPrintByDrawing disabled while printing](Printing_images/Printing_img18.png)
...
![WPF DataGrid displaying the column styling with AllowPrintByDrawing enabled while printing](Printing_images/Printing_img19.png)
...
![WPF DataGrid displaying the column styling with AllowPrintByDrawing disabled while printing](Printing_images/Printing_img20.png)
...
![WPF DataGrid Displaying print the selected items](Printing_images/Printing_img21.png)
...
![WPF DataGrid displaying the custom print preview window](Printing_images/Printing_img22.png)
