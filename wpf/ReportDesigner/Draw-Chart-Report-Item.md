...
1. Click Chart in the Insert Tab,Select Insert Chart in the list and drag it to the Report designer.
   ...
   ![Draw-Chart-Report-Item_images1](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img1.png)

2. A Chart properties wizard opens,Click OK.Then chart will be added with its default properties.

   ![Draw-Chart-Report-Item_images2](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img2.png)
   
   ![Draw-Chart-Report-Item_images3](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img3.png)
...
6. To Apply Styles to the Charts,Right Click on the Chart and select the Chart Properties from the context menu.
   ...
   ![Draw-Chart-Report-Item_images4](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img4.png)
...
7. In the Chart Properties dialog, select any of the following.
   ...
   * Appearance - To set the Chart name and border options and background options.
   ...
   ![Draw-Chart-Report-Item_images5](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img5.png)
...
9. Right click on the chart and select Legend Properties from the context menu.
   ...
   ![Draw-Chart-Report-Item_images6](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img6.png)
...
10. The Legend Properties dialog opens. Select any of the following.
    ...
    * Border - To set the border color and border width of the legend.
	...
	![Draw-Chart-Report-Item_images7](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img7.png)
...
12. Right click on the chart and select Value Axis Properties from the context menu.
    ...
    ![Draw-Chart-Report-Item_images8](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img8.png)
    ...
    * Tick - To set the style, width, color, and length of the value axis tick, and set the visibility of the major and minor tick marks.
	...
	![Draw-Chart-Report-Item_images9](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img9.png)
...
14. Right click on the chart and select Category Axis Properties from the context menu.
    ...
    ![Draw-Chart-Report-Item_images10](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img10.png)
	...
	* Tick - To set the style, width, color, and length of the value axis tick, and set the visibility of the major and minor tick marks.
	...
	![Draw-Chart-Report-Item_images11](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img11.png)
...
16. Right click on the chart and select Chart title Properties from the context menu.
    ...
    ![Draw-Chart-Report-Item_images12](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img12.png)

    * General - To set the chart title options like title, font, color, size, background and style. 
	
	![Draw-Chart-Report-Item_images13](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img13.png)
...
18. Right click on the chart and select Category Axis title Properties from the context menu.
    ...
    ![Draw-Chart-Report-Item_images14](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img14.png)

    * General - To set the chart title options like title, font family, font color, font size, title alignment and font style.
	
	![Draw-Chart-Report-Item_images15](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img15.png)
...
20. Right click on the chart and select Value Axis title Properties from the context menu.	
    ...
    ![Draw-Chart-Report-Item_images16](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img16.png)

    * General - To set the chart title options like title, font family, font color, font size, title alignment and font style.
	
	![Draw-Chart-Report-Item_images17](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img17.png)
	
21. Click OK to update the values for Category Axis title.

22. To delete the chart,Right click and select delete.

    ![Draw-Chart-Report-Item_images18](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img18.png)
	
	![Draw-Chart-Report-Item_images19](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img19.png)
...
3. If dataset is already added select available datasets and click Next.
   ...
   ![Draw-Chart-Report-Item_images20](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img20.png)

4. Drag to available fields to the corresponding Series,Categories and values and click Next.

   ![Draw-Chart-Report-Item_images21](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img21.png)

5. Select the Style and Layout of the table and click Finish.

   ![Draw-Chart-Report-Item_images22](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img22.png)
   
6. Then the chart will display with the selected fields.

   ![Draw-Chart-Report-Item_images23](Draw-Chart-Report-Item_images/Draw-Chart-Report-Item_img23.png)
