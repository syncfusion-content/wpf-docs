---
layout: post
title: Swimlane in WPF Kanban Board | Syncfusion
description: Learn about Swimlane support in Syncfusion WPF Kanban Board using the SwimlaneKey property and customize swimlane headers with templates.
platform: wpf
control: SfKanban
documentation: ug
---
