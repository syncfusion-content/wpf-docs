...
`RibbonListBox` control is used to display a list of items in a WPF Ribbon Control. It accepts any type of content as RibbonListBox items, but uses `ListBoxItem` by default.
