...
The `RibbonSeparator` is used to separate similar sets of control elements in WPF Ribbon Control. It can separate RibbonButtons according to their purpose. 
