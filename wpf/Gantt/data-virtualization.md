...
The following code illustrates explain about how to handle inline records by using this property:
...
 <syncfusion:GanttControl x:Name="Gantt"
    ...
    <syncfusion:GanttControl.Resources>
        <Style x:Key="HeaderNode" TargetType="syncfusion:HeaderNode">
...
this.Gantt.ItemsSource = new ResourceViewModel().Tasks;
...
N> Only the Gantt nodes and the Gantt chart (tasks and timeline) are virtualized. Other items shown in the chart area are not virtualized.
