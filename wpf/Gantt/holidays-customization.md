...
The WPF Gantt Control allows customers to differentiate the dates of holidays. This support is used to highlight the holidays in the Gantt chart.
...
The following properties in the WPF Gantt Control are used to customize the holiday feature:
