...
1. Define the Gantt with a custom numeric schedule source. For more information about custom numeric schedules, visit the following link: <http://docs.syncfusion.com/wpf/gantt/custom-schedule#custom-numeric>
