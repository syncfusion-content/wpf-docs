...
Diagram control provides support to change the selection handle display mode of the Node, Connector, and Group by using the [`SelectorHandleDisplayMode`](https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Diagram.SelectorHandleDisplayMode.html) property.
