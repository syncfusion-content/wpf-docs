...
ChartSeries is the visual representation of data. SfChart offers many types of series ranging from LineSeries to FinancialSeries like HiLo and Candle. Based on your requirements and specifications, you can add any type of series for data visualization. 

The following APIs are common for most series types:
...
* [`IsSeriesVisible`](https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Charts.ChartSeriesBase.html#Syncfusion_UI_Xaml_Charts_ChartSeriesBase_IsSeriesVisible) – A boolean property used to enable or disable the series visibility.
