...
description: Learn about the Syncfusion Essential Studio WPF Docking control, its overview, features, and more details.
platform: wpf
...
**MDI** : Allows the multiple windows to reside under a single parent window in the WPF Docking Control.

**TDI** : Allows adding the child window as a document tab in the WPF Docking Control.
...
**Nested Layout** : Provides complete support to add the WPF Docking Control as a child window to another WPF Docking Control.
