...
N> When the window state is in MDI, child of WPF Docking Control will be hosted inside the WPF Tabbed MDI Form. So, user can customize child using WPF Tabbed MDI Form. For customization, refer to this [documentation](https://help.syncfusion.com/wpf/tabbed-mdi-form/getting-started).
