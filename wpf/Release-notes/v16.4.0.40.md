...
<div id="license">
Starting with version 16.4.0.40 (2018 Volume 4), Syncfusion has removed the .NET Framework 3.5 and 4.5.1 from WPF setup and providing the separate add on setup. 
