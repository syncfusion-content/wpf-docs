---
layout: post
title: 13423-Defining the property in PivotGrid
description: 1.3.4.23 defining the property in pivotgrid
platform: wpf
...
**CalculationType** is the property can be set for the corresponding PivotCalculation item through **PivotComputationInfo** class. It can be set either through *XAML* or through *Code-Behind*.
