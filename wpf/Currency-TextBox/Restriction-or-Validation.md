...
![Validating Minimun Value of WPF CurrencyTextBox](Restriction-or-Validation_images/wpf-currency-textbox-min-value-validation.jpeg)

`MaxValidation` is set to OnLostFocus, so the `MaxValidation` will be performed only in the lost focus.

![Validating Maximum Value of WPF CurrencyTextBox](Restriction-or-Validation_images/wpf-currency-textbox-max-value-validation.jpeg)
...
![WPF CurrencyTextBox in Read-only Mode](Restriction-or-Validation_images/wpf-currency-textbox-readonly.jpeg)
