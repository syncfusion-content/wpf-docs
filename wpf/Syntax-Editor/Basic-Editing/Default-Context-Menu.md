...
description: The default context menu in WPF Syntax Editor provides quick access to common editing commands for enabling efficient text editing and code management.
platform: wpf
