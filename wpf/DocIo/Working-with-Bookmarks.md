...
section.AddParagraph();paragraph = section.AddParagraph();
...
bn.MoveToBookmark("bm_empty")bn.ReplaceContent(part)
{% endhighlight  %}
{% endtabs %}
...
{% tabs %}
{% highlight c# %}
//Moves to the Essential_DocIO bookmark.
...
//Saves the extractDocument in local machineextract
