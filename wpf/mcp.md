---
layout: post
title: Syncfusion® WPF MCP Server | Syncfusion®
description: Learn how to configure and use Syncfusion® WPF MCP server for intelligent code generation, documentation, and troubleshooting in WPF apps.
platform: wpf
control: Getting started with Syncfusion® WPF MCP Server
documentation: ug
---
...
- **Expert Component Knowledge** - Deep understanding of 100+ WPF components and their implementation patterns.
...
The examples below showcase how the `search_docs` tool handles real-world WPF development scenarios. The tool can be invoked directly, as shown in the examples below, for specific needs. Alternatively, an AI assistant can automatically invoke it based on the request.
...
#search_docs Create a Syncfusion WPF Grid with paging, sorting, and filtering enabled.
{% endpromptcard %}
{% endpromptcards %}
...
- **Be Specific** - Include the platform and component in your queries (for example, *"Create a Syncfusion WPF Grid with paging and filtering"*).
