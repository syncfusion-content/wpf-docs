...
<tr>
<td>
{{ '**Value Type**' | markdownify }}</td><td>
{{ '**Cell type**' | markdownify }}</td></tr>
<tr>
<td>
String</td><td>
TextBox</td></tr>
...
<tr>
<td>
{{ '**GridStyleInfo**' | markdownify }}</td><td>
{{ '**Description**' | markdownify }}</td></tr>
<tr>
<td>
CellType</td><td>
...
<tr>
<td>
{{ '**Date and Time Pattern**' | markdownify }}</td><td>
