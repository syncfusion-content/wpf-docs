---
layout: post
title: Localization in WPF PropertyGrid | Syncfusion®
description: Localization in PropertyGrid enables translating built-in UI text using culture-specific resource files and application cultures.
platform: wpf
...
![PropertyGrid contain localized today and none button text](Localization_images/wpf-PropertyGrid-localization.png)
