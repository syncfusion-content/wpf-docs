...
You can also refer to the [**web installer**](https://help.syncfusion.com/wpf/installation/install-using-the-web-installer) links for step-by-step installation guidelines.	
