...
2.	To unlock the Syncfusion offline installer, you have two options:
    ...
    **Use Unlock Key**
    ...
    To learn how to generate an unlock key for both trial and licensed products, see [this](https://support.syncfusion.com/kb/article/2757/how-to-generate-syncfusion-setup-unlock-key-from-syncfusion-support-account?isInternalRefresh=False) Knowledge Base article.
