...
description: Learn here all about to customize the Timeline day, week, workweek, month views settings in Syncfusion WPF Scheduler (SfScheduler) control and more.
platform: wpf
control: SfScheduler
documentation: ug
---
