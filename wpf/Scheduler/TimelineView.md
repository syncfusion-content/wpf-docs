...
You can customize the interval height of timeslots in Timeline view by setting `TimeIntervalHeight` property of `TimelineViewSettings`.
{% tabs %}
{% highlight xaml %}
...
You can customize the size of the time ruler view where the labels mentioning the time are placed by using the `TimeRulerSize` property of `TimelineViewSettings`.
{% tabs %}
{% highlight xaml %}
<syncfusion:SfScheduler x:Name="Schedule" ViewType="Timeline" >
    <syncfusion:SfScheduler.TimelineViewSettings>
...
You can customize the format for the labels mentioning the time, by setting the `TimeRulerFormat` property of `TimelineViewSettings` in `Scheduler`.
{% tabs %}
{% highlight c# %}
Schedule.ViewType = SchedulerViewType.Timeline;
...
## Appointment height
You can customize the height of the appointment in `TimelineView` using the `TimelineAppointmentHeight` property of `TimelineViewSettings`. By default, its value is 50.
{% tabs %}
{% highlight xaml %}
<syncfusion:SfScheduler x:Name="Schedule" ViewType="Timeline"> 
    <syncfusion:SfScheduler.TimelineViewSettings>
