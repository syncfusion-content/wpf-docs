...
* If [ShowAgendaView](https://help.syncfusion.com/wpf/scheduler/month-view#month-agenda-view) is true in month view, the month view should navigate to the day view by single clicking on the agenda date view header, otherwise the month view should navigate to the day view by single clicking on the date in month cell. 