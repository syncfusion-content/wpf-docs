---
layout: post
title: Filtering in WPF MultiColumn Dropdown | Syncfusion®
description: Filtering in Syncfusion® WPF MultiColumn Dropdown enables typed text search with case sensitivity, diacritic handling, and delay options.
platform: wpf
...
![The image describes the AllowIncrementalFiltering support](Filtering_images/Filtering_img1.png)
