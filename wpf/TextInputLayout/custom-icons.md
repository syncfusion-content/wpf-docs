---
layout: post
title: Custom Icons in WPF Text Input Layout | Syncfusion®
description: Custom Icons in WPF Text Input Layout enable adding and positioning leading or trailing icons to enhance input field appearance.
platform: wpf
control: SfTextInputLayout
documentation: ug
---

# Custom Icons in WPF Text Input Layout (SfTextInputLayout)
