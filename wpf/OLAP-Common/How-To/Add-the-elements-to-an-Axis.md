---
layout: post
title: Adding the elements to an Axis| OLAPCommon | Wpf | Syncfusion
description: Adding the elements to an axis in Syncfusion Essential Studio WPF OLAPCommon control, its elements, and more.
platform: wpf
control: OLAPCommon
documentation: ug
---
